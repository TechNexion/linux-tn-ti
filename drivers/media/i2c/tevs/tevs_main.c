...
static void tevs_init_formats(struct v4l2_subdev *sub_dev, struct v4l2_subdev_state *state)
{
	struct tevs *tevs =
		container_of(sub_dev, struct tevs, v4l2_subdev);
	...
	format->width = tevs_sensor_table[tevs->selected_sensor].res_list[tevs->selected_mode].width;
	format->height = tevs_sensor_table[tevs->selected_sensor].res_list[tevs->selected_mode].height;
                              ...
                              struct v4l2_subdev_state *state)
{
	...
	tevs_init_formats(sub_dev, state);
                          ...
                          struct v4l2_subdev_state *state)
{
	...
	ret = _tevs_set_routing(sub_dev, state);
                                ...
                                struct v4l2_mbus_frame_desc *fd)
{
	...
	state = v4l2_subdev_lock_active_state(sub_dev);
